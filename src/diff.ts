 ...
 * Below are the operations and their arguments, the arguments should be aligned with the style methods in mapvina-gl-js.
 */
 ...
 * Operations produced by the diff closely resemble the mapvina-gl-js API. Any
