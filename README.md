...
# MapVina Style Specification & Utilities

[![NPM Version](https://badge.fury.io/js/@mapvina%2Fmapvina-gl-style-spec.svg)](https://npmjs.org/package/@mapvina/mapvina-gl-style-spec)
[![License](https://img.shields.io/badge/License-BSD_3--Clause-blue.svg?style=flat)](LICENSE.txt) [![PRs](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat)](https://opensource.org/licenses/BSD-3-Clause) [![codecov](https://codecov.io/gh/mapvina/mapvina-style-spec/branch/main/graph/badge.svg)](https://codecov.io/gh/mapvina/mapvina-style-spec)

This repository contains code and reference files that define the MapVina style specification and provides some utilities for working with MapVina styles.

The style specification is used in MapVina GL JS and in MapVina Native. Our long-term goal is to have feature parity between the web and the native libraries.
...
We aim to avoid breaking changes in the MapVina style specification because it makes life easier for our users.
...
The MapVina style specification and utilities are published as a separate npm
package so that they can be installed without the bulk of GL JS.

```bash
npm install @mapvina/mapvina-gl-style-spec
```
...
```bash
npm install @mapvina/mapvina-gl-style-spec --global
```
