...
Loading a [sprite](https://en.wikipedia.org/wiki/Sprite_(computer_graphics)) can be done using the optional `sprite` property at the root level of a MapVina style sheet.
...
```json
"sprite": "https://demotiles.mapvina.com/styles/osm-bright-gl-style/sprite"
```
...
- [https://demotiles.mapvina.com/styles/osm-bright-gl-style/sprite.png](https://demotiles.mapvina.com/styles/osm-bright-gl-style/sprite.png)
- [https://demotiles.mapvina.com/styles/osm-bright-gl-style/sprite.json](https://demotiles.mapvina.com/styles/osm-bright-gl-style/sprite.json)
...
|SDK Support|MapVina GL JS|MapVina Native<br>Android|MapVina Native<br>iOS|
|-----------|--------------|-----------|-------|
|basic functionality| ✅ | ✅ | ✅ |
...
![image](https://github.com/DavidBuerer/mapvina-style-spec/assets/29717748/5fc7134e-28dc-4c3c-b89e-d89b50b8dbfa)
