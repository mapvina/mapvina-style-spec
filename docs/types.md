...
MapVina style contains values of various types, most commonly as values for the style properties of a layer.
...
A string is text. In MapVina styles, strings are in quotes.
